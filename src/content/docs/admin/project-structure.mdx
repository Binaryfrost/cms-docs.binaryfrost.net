...
This directory stores [custom hooks](/admin/plugins/hook-plugins/).

A `hooks.config.ts` file is required if you want to register custom hooks.

### src/inputs

This directory stores [custom Inputs](/admin/plugins/input-plugins/).

A `inputs.config.ts` file is required if you want to register custom Inputs.

### src/routes

This directory stores [custom routes](/admin/plugins/route-plugins/).
