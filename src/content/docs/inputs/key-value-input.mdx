...
<InputExample image="key-value-settings" isSetting />
...
:::note
When updating a Key Value Input through the API, you must send an array of key-value pairs in the format `[string, any][]`.
:::
